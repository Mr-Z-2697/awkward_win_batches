...
for %%x in (%*) do (
    ffmpeg -loglevel 0 -r 1 -i "%%~dpnxx" -vf zscale=m=470bg:r=pc:f=5:d=error_diffusion,format=yuv444p10le -frames 1 -f yuv4mpegpipe -strict -1 -|x265 --input - --y4m --preset 6 --crf %q% --no-sao --selective-sao 0 --ref 1 --bframes 0 --aq-mode 1 --psy-rd 2 --psy-rdoq 8 --cbqpoffs 1 --crqpoffs 1 --range full --colormatrix bt470bg --no-info -D 10 -o "%temp%\%%~nxx.heic.hevc"
    ffmpeg -loglevel 0 -r 1 -i "%%~dpnxx" -vf extractplanes=a,zscale=r=pc,format=yuv444p10le -frames 1 -f yuv4mpegpipe -strict -1 -|x265 --input - --y4m --preset 6 --crf %q% --no-sao --selective-sao 0 --ref 1 --bframes 0 --aq-mode 1 --psy-rd 2 --psy-rdoq 8 --cbqpoffs 1 --crqpoffs 1 --range full --colormatrix bt470bg --no-info -D 10 -o "%temp%\%%~nxx.alpha.hevc"
